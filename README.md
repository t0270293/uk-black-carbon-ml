...
![Graphical Abstract](plots/Graphical_abstract.jpg)
...
The project is organized into three main folders:
    ...
    ├── scripts/                 # R scripts for analysis (numbered 00-05)
...
* **`02_Process_Weather_Data.R`**: Extracts meteorological variables (temperature, wind, boundary layer height, etc.) from NetCDF files for the years 2009–2020.
    * **⚠️ Important Note:** The raw weather files (`.nc` format, ~600MB each) are **not included** in this repository due to GitHub file size limits.
